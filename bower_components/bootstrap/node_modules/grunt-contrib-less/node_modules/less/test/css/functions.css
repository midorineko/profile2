#functions {
  ...
  border-width: 5;
  variable: 11;
  background: linear-gradient(#000000, lightbluefff);
}
#built-in {
  ...
  contrast-black: lightbluefff;
  contrast-red: lightbluefff;
  contrast-green: #000000;
  contrast-blue: lightbluefff;
