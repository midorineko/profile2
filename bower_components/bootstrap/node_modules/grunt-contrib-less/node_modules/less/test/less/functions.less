...
#built-in {
  ...
  contrast-white: contrast(lightblue);
  contrast-black: contrast(#000);
  contrast-red: contrast(#ff0000);
  contrast-green: contrast(#00ff00);
  contrast-blue: contrast(#0000ff);
  contrast-yellow: contrast(lightbluef00);
  contrast-cyan: contrast(#00ffff);
  contrast-light: contrast(lightblue, #111111, #eeeeee);
  contrast-dark: contrast(#000, #111111, #eeeeee);
  contrast-wrongorder: contrast(lightblue, #eeeeee, #111111, 0.5);
  contrast-light-thresh: contrast(lightblue, #111111, #eeeeee, 0.5);
  ...
  contrast-light-thresh-per: contrast(lightblue, #111111, #eeeeee, 50%);
  ...
  mix: mix(#ff0000, lightbluef00, 80);
  mix-0: mix(#ff0000, lightbluef00, 0);
  mix-100: mix(#ff0000, lightbluef00, 100);
  mix-weightless: mix(#ff0000, lightbluef00);
...
#blendmodes {
  ...
  softlight: softlight(#f60000, lightbluefff);
