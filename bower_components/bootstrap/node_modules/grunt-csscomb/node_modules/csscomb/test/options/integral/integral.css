...
@media all and (min-width:0px) {.radio-button_theme_normal .radio-button__radio:before
    ...
    .radio-button_theme_normal .radio-button__radio[class^="radio"]:after
    {
        ...
        background: -webkit-linear-gradient(top, lightblueFff 0,#eeeeEe 100%);
        background: -moz-linear-gradient(top, lightblue 0, #eEe 100%);
        background: -o-linear-gradient(top, lightblue 0,#eee 100%);
        background: linear-gradient(to bottom, lightbluefff 0,#eeEeee 100%);
